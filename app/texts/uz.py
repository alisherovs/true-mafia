TEXTS = {
    ...
    "start_menu": (
        "<b>Salom!</b>\n"
        "Men 🕵🏻 Mafia o'yini botiman."
    ),
    "add_to_group": "O'yinni guruhingizga qo'shing +",
    "premium_groups": "🎲 Premium guruhlar",
    "news": "Yangiliklar ↗",
    "lang": "🌍 Til",
    "rules_btn": "🃏 O'yin qoidalari",
    "language_saved": "✅ Til saqlandi.",
    "private_only": "Bu buyruq private chatda ishlaydi.",
    "group_only": "Bu buyruq guruhda ishlaydi.",
    "bot_not_admin": "⚠️ Botni admin qiling va qayta urinib ko'ring.",
    "active_game_exists": "⚠️ Bu chatda allaqachon aktiv ro'yxatdan o'tish yoki o'yin bor.",
    "registration_started": "✅ Ro'yxatdan o'tish boshlandi.",
    "registration_ended": "✅ Ro'yxatdan o'tish yakunlandi.",
    "registration_closed_cb": "Ro'yxatdan o'tish yakunlangan.",
    "extended": "⏳ Ro'yxatdan o'tish vaqti uzaytirildi.",
    "no_permission": "Sizda bu amal uchun ruxsat yo'q.",
    "joined": "Siz o'yinga qo'shildingiz.",
    "already_joined": "Siz allaqachon qo'shilgansiz.",
    "left_game": "Siz ro'yxatdan chiqdingiz.",
    "not_joined": "Siz ro'yxatdan o'tmagansiz.",
    "game_cancelled": "🛑 O'yin to'xtatildi.",
    "insufficient_players": "❌ O'yin bekor qilindi: o'yinchi yetarli emas.",
    "need_start_for_role": "Rolni olish uchun botga o‘ting: /start",
    "timer_60": "⏳ Ro'yxatdan o'tish tugashiga 60 soniya qoldi!",
    "timer_30": "⏳ Ro'yxatdan o'tish tugashiga 30 soniya qoldi!",
    "night_title": (
        "🌚 <b>🌃Tun</b>\n\n"
    ...
    "day_title": (
        "☀️ <b>🌇Kun</b>\n\n"
        "Tong otdi. Shaharda kecha nimalar bo'lganini bilib olamiz..."
    ),
    "go_bot": "Bot-ga o'tish ↗",
    "vote_started": "🗳 Ovoz berish boshlandi. Kimni chiqaramiz?",
    "vote_done": "Ovozingiz qabul qilindi.",
    "vote_already": "Siz allaqachon ovoz bergansiz.",
    "not_alive": "Siz o'lgansiz, bu amal mavjud emas.",
    "teamgame_stub": "🏆 Turnir o'yini hozircha tayyorlanmoqda.",
...
Yakka rol. Tunda tanlagan odamini eshigi oldiga mina qo'yadi va u uyga o'sha tunda kelgan Miniordan boshqalar o'ladi.""",
    ...
    "profile_fmt": (
        ...
        "👤 {display_name}\n\n"
        "<tg-emoji emoji-id=\"5375296873982604963\">💰</tg-emoji> Dollar: <b>{dollar}</b>\n"
        "<tg-emoji emoji-id=\"5471952986970267163\">💎</tg-emoji> Olmos: <b>{diamonds}</b>\n\n"
        "🛡 Himoya: {protection}\n"
    ...
    "give_started": "<tg-emoji emoji-id=\"5471952986970267163\">💎</tg-emoji> Diamond yuborish uchun /give ishlating.",
    "give_not_enough": "Balansingizda yetarli diamond yo'q.",
    "give_success": "✅ {amount} <tg-emoji emoji-id=\"5471952986970267163\">💎</tg-emoji> yuborildi.",
    "give_received": "🎁 Sizga {amount} <tg-emoji emoji-id=\"5471952986970267163\">💎</tg-emoji> keldi.",
    ...
    "you_win": "<b>Siz yutdingiz!</b>\nYutganingiz uchun sizga <tg-emoji emoji-id=\"5375296873982604963\">💰</tg-emoji> {dollar}, <tg-emoji emoji-id=\"5471952986970267163\">💎</tg-emoji> {diamond} berildi!",
    "you_lose": "<b>Siz yutqazdingiz!</b>\nLekin o‘yinda qatnashganingiz uchun <tg-emoji emoji-id=\"5375296873982604963\">💰</tg-emoji> {dollar}, <tg-emoji emoji-id=\"5471952986970267163\">💎</tg-emoji> {diamond} berildi!",
    ...
    "action_already": "Bu bosqich uchun allaqachon harakat qilgansiz.",
    "no_active_game": "Aktiv o'yin topilmadi.",
    "cannot_leave_running": "O'yin davomida chiqib ketish ruxsat etilmagan.",
}
